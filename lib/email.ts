      ...
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:0;background:#0a0e1f;color:#e2e8f0">
        ...
        <div style="padding:32px;background:#0f1629;border-radius:0 0 16px 16px">
          ...
          <div style="text-align:center;margin:32px 0">
            <a href="https://www.vosmart.ro/login" style="display:inline-block;background:linear-gradient(135deg,#7c3aed,#6d28d9);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:600;font-size:15px">
