...
const services = [
  ...
  },
  {
    ...
    href: "/cenzorat-blocuri",
  },
  {
    icon: "🧾",
    title: "Audit financiar-contabil",
    text: "Verificarea gestiunii, a fondurilor și a soldurilor asociației, cu constatări documentate pe fiecare sumă.",
    href: "/audit-financiar-contabil",
  },
  {
    icon: "🏛️",
    title: "Firmă de cenzorat",
    text: "Mandat de cenzorat asigurat contractual de o persoană juridică specializată, nu de o singură persoană.",
    href: "/firma-de-cenzorat",
  },
  {
    icon: "📊",
            ...
            <div className="grid gap-10 lg:grid-cols-4">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-500">
                  {[
                    ["Firmă de cenzorat", "/firma-de-cenzorat"],
                    ["Cenzorat asociații", "/cenzorat-asociatii"],
                    ["Cenzorat blocuri", "/cenzorat-blocuri"],
                    ["Audit financiar-contabil", "/audit-financiar-contabil"],
                    ["Ghiduri și articole", "/blog"],
                  ].map(([label, href])=>(
                    <li key={href}><Link href={href} className="transition hover:text-slate-300">{label}</Link></li>
                  ))}
                </ul>
              </div>
              <div>
